...
public class Salary {
	...
	{
		this.basicSalary=basicSalary;
		this.hra=30*basicSalary/100;
		this.otherAllowance=20*basicSalary/100;
		this.personalAllowance=25*basicSalary/100;
		this.conveyenceAllowance=15*basicSalary/100;
		this.grossSalary=basicSalary+hra+conveyenceAllowance+personalAllowance+otherAllowance;
		this.netSalary=grossSalary*12;
	}
